...
class Process:
    ...
    def process_signal(
        ...
        start_i, end_i = _segment_to_indices(signal, sampling_rate, start, end)
    ...
    def read_audio(
        ...
        return _read_audio(path, start, end, channel)
...
class ProcessWithContext:
    ...
    def process_signal_from_index(
        ...
        # Process signal
        starts_i, ends_i = _segments_to_indices(signal, sampling_rate, index)
